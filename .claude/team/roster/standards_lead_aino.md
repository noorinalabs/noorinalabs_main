...
|----------|-----------|-------|
| Quality enforcement | Pre-commit hooks, CI gates | Automated over manual wherever possible |
| Standards docs | Charter files in Markdown | Living documents, versioned with the repo |
| Linting | Repo-specific linters orchestrated centrally | Consistent config across repos |
| Hook management | Python scripts in .claude/hooks/ | Testable, with clear error messages |
| Convention tracking | GitHub Issues labeled `standards` | Track deviations and remediation |
