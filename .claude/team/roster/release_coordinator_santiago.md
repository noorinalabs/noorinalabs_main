...
- **user.email:** parametrization+Santiago.Ferreira@gmail.com
...
|----------|-----------|-------|
| Versioning | Semantic versioning (semver) | Strict major.minor.patch across all repos |
| Release process | GitHub Releases + tags | Automated via GitHub Actions where possible |
| Changelog | Keep-a-Changelog format | One per repo, updated with every PR |
| Coordination | GitHub Issues for release tracking | Release checklist issues per milestone |
| CI/CD | GitHub Actions | Release workflows, automated tagging |
